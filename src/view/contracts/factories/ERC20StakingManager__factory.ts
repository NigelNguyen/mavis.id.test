...
import type {
  ERC20StakingManager,
  ERC20StakingManagerInterface,
} from "../ERC20StakingManager";
...
export class ERC20StakingManager__factory {
  static readonly abi = _abi;
  static createInterface(): ERC20StakingManagerInterface {
    return new utils.Interface(_abi) as ERC20StakingManagerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ERC20StakingManager {
    return new Contract(address, _abi, signerOrProvider) as ERC20StakingManager;
  }
}
